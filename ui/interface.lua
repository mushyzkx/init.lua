-- ui/interface.lua
-- Interface Rayfield - Auto Farm estilo Redz Hub

return function(Modules)
    local Rayfield = loadstring(game:HttpGet('https://sirius.menu/rayfield'))()
    
    local Window = Rayfield:CreateWindow({
        Name = "Blox Fruits Hub - Redz Style",
    ...
    FarmTab:CreateSlider({
        ...
        Flag = "ClickSpeed",
        Callback = function(Value)
            Modules.AutoFarm.FastClickSpeed = Value
        end
    })
    ...
    local Islands = {
        ...
        ["Sea 1 - Underwater City"] = CFrame.new(61122, 18, 1567),
        ["Sea 1 - Fountain City"] = CFrame.new(5129, 59, 4105),
        ...
        ["Sea 2 - Ice Castle"] = CFrame.new(2000, 50, -4000),
        ["Sea 2 - Forgotten Island"] = CFrame.new(-3000, 300, -1000),
        ...
        ["Sea 3 - Castle on the Sea"] = CFrame.new(-5000, 350, -3000),
        ["Sea 3 - Haunted Castle"] = CFrame.new(-8500, 50, 6500),
        ["Sea 3 - Sea of Treats"] = CFrame.new(-1000, 80, -12000),
        ["Sea 3 - Tiki Outpost"] = CFrame.new(-16000, 10, 500),
    }
